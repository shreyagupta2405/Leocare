...
function Environment() {
    ...
    const addEventToStore = async (data, url) => {
        try {
            await environmentService.addEvent(
                {
    ...
    const updateEventToStore = async (data, url) => {
        ...
        try {
            await environmentService.updateEvent(
                editId,
                {
                    "heading":data?.heading,
                    "content": data?.content,
    ...
    const deleteEvent = async (id) => {
        await environmentService.deleteEvents(id);
        getAllEventFromStore();
    }
    ...
    const editHandler = async (id) => {
        setEdit(true);
        setEditId(id);
        const docSnap = await environmentService.getEvent(id);
