...
function Docs() {
    ...
    const onSubmit = async (data) => {
        if (image) {
            const imageRef = ref(storage, `pdf/${"1" + v4()}`);
    ...
    const deleteEvent = async (id) => {
        await docsService.deleteEvents(id);
                            ...
                            <div className='p-2 m-4 w-5/6 outline-double'>
                                <div className='flex justify-center items-center'>
                                    ...
                                    ' src={data?.url
                                        ...
                                        {/* <button className='bg-primary text-white rounded-lg w-24 h-8'>show pdf
                                        </button> */}
                                        <embed type='application/pdf' src={data?.url}></embed>
                                </div>
                                <div className='flex justify-center items-center'>
