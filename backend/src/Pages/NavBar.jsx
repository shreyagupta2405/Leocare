    ...
    <div className=" flex flex-wrap items-center justify-between mx-auto ">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul className="flex flex-col  mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 items-center">
                ...
                <li>
                <Link to='/events' className='hover:text-primary'>Events/Home</Link>
                </li>
                <li>
                <Link to='/edu-home' className='hover:text-primary'>Educate/Home</Link>
                </li>
                <li>
                <Link className='hover:text-primary'>Environment/Home</Link>
                </li>

                <li>
                <Link className='hover:text-primary'>Skill Development/Home</Link>
                </li>
