...
function Card({ link, title, imageUrl, body, target }) {
  ...
  return (
    ...
    <div className=' card-container hover:transform w-72  overflow-hidden shadow-lg rounded-xl h-[30rem]'>
