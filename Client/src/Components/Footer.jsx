            ...
            <div className='bg-gray-500 text-white'>
                ...
                <div id='contactus' class=" mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    <div class="max-w-sm lg:max-w-none mt-24 px-16">
                        <p class=" mt-4 lg:ml-24 text-center lg:text-left lg:text-lg ">
                            <div className='text-center text-white'>Keep up with our events on social media </div>
                            ...
                            <div className='text-white items-center justify-center mt-3 font-extrabold flex flex-row'><IoMdContact className=' text-white transition hover:text-white' size={20}/> Contact</div>
                        </p>
                        ...
                        <div class="mt-1 lg:ml-24 flex  gap-6 justify-center items-center">
                            ...
                            <a
                                className="flex justify-center items-center text-white transition hover:text-gray-700/75"
                            ...
                            <a
                                className="flex justify-center items-center text-white transition hover:text-gray-800/75"
                                href="/docs"
                                target=""
                                rel="noreferrer">
                    ...
                    >
                        ...
                        <div>
                            <strong class="items-center justify-center flex flex-row gap-2 text-lg text-white mt-4">
                            ...
                            >
                                <div class="text-center text-white transition " >
                                    Libra avenue, Nadergul, Hyderabad,
                                </div>
                                <div class="text-center text-white0 transition " >
                        ...
                        <div>
                            <strong class="flex flex-row items-center justify-center gap-2 text-lg text-white mt-4">
                            ...
                            >
                                <div class="items-center justify-center flex text-white transition ">
                                    +91 9398695177
                                </div>
                ...
                <div class="mt-16 border-t border-gray-100 pt-8">
                    <p class="text-center text-xs leading-relaxed text-white gap-4 flex flex-row justify-center items-center">
